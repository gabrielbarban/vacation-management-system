    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          ...
          <p className="text-xs text-gray-500">Admin: admin@taskflow.com / admin123</p>
          <p className="text-xs text-gray-500">Manager: manager@taskflow.com / manager123</p>
          <p className="text-xs text-gray-500">User: user@taskflow.com / user123</p>
        </div>
      </div>
    </div>
  );
